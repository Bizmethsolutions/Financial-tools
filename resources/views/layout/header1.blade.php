<nav class="navbar fullwith">
    ...
    <div class="navbar-content">
        <a href="{{ url('company-list') }}"><img src="{{ asset('images/finsuite_logo.png') }}" style="width:13%;">
      <ul class="navbar-nav">
          ...
          <div class="dropdown-menu" aria-labelledby="profileDropdown">
            ...
            <div class="dropdown-body">
              <ul class="profile-nav p-0 pt-3">
                ...
                <!-- <li class="nav-item">
                  <a href="javascript:;" class="nav-link">
                    <img src="{{ asset('images/sync_now.png') }}" alt="profile" style="width:14px;height: 14px;border-radius: 0;">
                    <span class="padding-left-10">Sync Now</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="javascript:;" class="nav-link">
