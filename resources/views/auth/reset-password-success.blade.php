                ...
                <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <div class="row mr-0 ml-0 padding-25" style="background-color:rgba(20,140,232,5%);">
                        ...
                        <div class="col-md-10 my-auto pl-0">
                          ...
                          <span class="font-14 color-grey">Your password has been updated.</span>
                        </div>
                    ...
                    <div class="mt-12 padding-top-10">
                      <a href="{{ url('/login') }}"><button class="btn btn-primary mr-12 mb-12 mb-md-0 forgot-btn">RETURN TO LOGIN</button></a>
                    </div>
                </div>
            </div>
        </div>
